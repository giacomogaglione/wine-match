...
export default function Page({ bestPicks, italyMostPopular }) {
  return (
    <>
      <div className="relative mx-auto max-w-5xl pt-10 lg:pt-32">
        <div className="text-center text-4xl font-extrabold tracking-tight text-slate-800 dark:text-slate-300 md:text-5xl lg:text-6xl">
          Rapidly compare wines without changing tab.
        </div>
        <div className="mt-6 text-center text-lg font-semibold text-slate-600 dark:text-slate-400">
        ...
        <div className="mt-6 flex-row items-center justify-center text-center lg:flex lg:space-x-6">
          <Link href="/explore">
            <div className="mb-6 rounded-full bg-indigo-600 px-6 py-2 text-lg font-bold text-white hover:bg-indigo-400 focus:outline-none dark:bg-indigo-600 dark:text-slate-100 dark:hover:bg-indigo-700 lg:mb-0">
              Explore All
            </div>
          </Link>
          <SearchBar />
      ...
      <Features />
      <div>
        <div className="my-6 rounded-xl bg-gradient-to-l from-indigo-400/20 via-indigo-300/20 to-emerald-200/20 p-4 font-extrabold dark:from-indigo-900/20 dark:via-indigo-700/20 dark:to-emerald-800/20">
        ...
        <div className="my-6 rounded-xl bg-gradient-to-r from-indigo-400/20 via-indigo-300/20 to-emerald-200/20 p-4 font-extrabold dark:from-indigo-900/20 dark:via-indigo-700/20 dark:to-emerald-800/20">
          <div className="text-2xl font-extrabold text-slate-800 dark:text-slate-300">
